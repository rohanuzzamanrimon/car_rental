...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($route_from) || empty($route_to) || $price <= 0 || empty($vehicle_type)) {
        ...
        try {
            ...
            ");
            $check_stmt->execute([$route_from, $route_to, $route_to, $route_from]);
            
            if ($check_stmt->rowCount() > 0) {
                $error = "A route between these cities already exists.";
            } else {
                $stmt = $conn->prepare("
                    INSERT INTO routes (route_from, route_to, price, vehicle_type, description, is_active) 
                    VALUES (?, ?, ?, ?, ?, ?)
                ");
                $stmt->execute([
                    $route_from, $route_to, $price, $vehicle_type, $description, $is_active
                ]);
...
<head>
    ...
    <title>Add New Route - Admin Panel</title>
    ...
    <div class="admin-container">
        <div class="car-form-container">
            <div class="form-header">
                ...
                <p>Create a new travel route with pricing and destination information</p>
            ...
            <?php if ($success): ?>
                <div class="alert alert-success">
                    ...
                    <a href="add.php" class="btn-link">Add Another Route</a>
                </div>
            <?php endif; ?>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo isset($_POST['route_from']) ? htmlspecialchars($_POST['route_from']) : ''; ?>"
                                       list="cities-list">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo isset($_POST['route_to']) ? htmlspecialchars($_POST['route_to']) : ''; ?>"
                                       list="cities-list">
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select id="vehicle_type" name="vehicle_type" required>
                                ...
                                <option value="Microbus" <?php echo (isset($_POST['vehicle_type']) && $_POST['vehicle_type'] === 'Microbus') ? 'selected' : ''; ?>>🚐 Microbus</option>
                ...
                <div class="form-section full-width">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="4" 
                                  placeholder="Describe the route, attractions, road conditions, or special features that make this destination appealing..."><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                    </div>
